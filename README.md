...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-njig1a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-njig1a.containers.anotherwebservice.com/
...
```
git clone git@github.com:Arash138080/container-njig1a.git
cd container-njig1a
```
...
```
docker attach container-njig1a
```
